...
VALUES
    (NULL, 'gabrielrocco', 'senha123', '02/04/1998', 'C:/...', 'gabrielr@fe.up.pt', 22);
INSERT into user
    (userID, username, pass, birthDate, profilePicture, email, age)
VALUES
    (NULL, 'murielpinho', 'senha123', '22/07/1996', 'C:/...', 'muriel@fe.up.pt', 23);
INSERT into user
    (userID, username, pass, birthDate, profilePicture, email, age)
VALUES
    (NULL, 'angela99', 'senha123', '07/05/1999', 'C:/...', 'angela_s@fe.up.pt', 19);
INSERT into user
    (userID, username, pass, birthDate, profilePicture, email, age)
VALUES
    (NULL, 'ines_silva331', 'senha123', '07/08/1998', 'C:/...', 'ines_silva2018@fe.up.pt', 19);
INSERT into user
    (userID, username, pass, birthDate, profilePicture, email, age)
VALUES
    (NULL, 'carloskk', 'senha123', '07/08/1995', 'C:/...', 'car_s_p@fe.up.pt', 19);
INSERT into user
    (userID, username, pass, birthDate, profilePicture, email, age)
VALUES
    (NULL, 'bernardo7845', 'senha123', '07/08/1999', 'C:/...', 'b_salles99@fe.up.pt', 19);
INSERT into user
    (userID, username, pass, birthDate, profilePicture, email, age)
VALUES
    (NULL, 'carlos_am', 'senha123', '06/05/1999', 'C:/...', 'carlosamarantes99@fe.up.pt', 20);
INSERT into user
    (userID, username, pass, birthDate, profilePicture, email, age)
VALUES
    (NULL, 'jv.s.santos', 'senha123', '27/02/2000', 'C:/...', 'jvsantos@fe.up.pt', 20);
INSERT into user
    (userID, username, pass, birthDate, profilePicture, email, age)
VALUES
    (NULL, 'maria8989', 'senha123', '06/11/2005', 'C:/...', 'maria8989@fe.up.pt', 15);
INSERT into user
    (userID, username, pass, birthDate, profilePicture, email, age)
VALUES
    (NULL, 'paulo.rafael.a99', 'senha123', '02/02/1999', 'C:/...', 'paulo.rafael@fe.up.pt', 20);

-- Table: channel

INSERT into channel
    (channelID, userID, name, biography, followerCount)
VALUES
    (1, 2, 'Channel A', NULL, 1125);
INSERT into channel
    (channelID, userID, name, biography, followerCount)
VALUES
    (2, 1, 'Channel B', NULL, 451);
INSERT into channel
    (channelID, userID, name, biography, followerCount)
VALUES
    (3, 4, 'Channel C', NULL, 831);
INSERT into channel
    (channelID, userID, name, biography, followerCount)
VALUES
    (4, 5, 'Channel D', NULL, 4456);
INSERT into channel
    (channelID, userID, name, biography, followerCount)
VALUES
    (5, 10, 'Channel E', NULL, 1154);
INSERT into channel
    (channelID, userID, name, biography, followerCount)
VALUES
    (6, 8, 'Channel F', NULL, 932);
INSERT into channel
    (channelID, userID, name, biography, followerCount)
VALUES
    (7, 6, 'Channel G', NULL, 131);
INSERT into channel
    (channelID, userID, name, biography, followerCount)
VALUES
    (8, 3, 'Channel H', NULL, 871);
INSERT into channel
    (channelID, userID, name, biography, followerCount)
VALUES
    (9, 7, 'Channel I', NULL, 532);
INSERT into channel
    (channelID, userID, name, biography, followerCount)
VALUES
    (10, 9, 'Channel J', NULL, 5463);
...
INSERT into message
    (messageID, content, dateSent)
VALUES
    (NULL, 'Bom dia', '05/04/2020 18:25:32');
INSERT into message
    (messageID, content, dateSent)
VALUES
    (NULL, 'Olá', '05/04/2020 18:25:36');
INSERT into message
    (messageID, content, dateSent)
VALUES
    (NULL, 'A live vai demorar?', '05/04/2020 18:25:44');
INSERT into message
    (messageID, content, dateSent)
VALUES
    (NULL, 'kkkkkkkkkk', '05/04/2020 18:26:01');
INSERT into message
    (messageID, content, dateSent)
VALUES
    (NULL, 'Bom dia Pedro', '05/04/2020 18:26:32');
INSERT into message
    (messageID, content, dateSent)
VALUES
    (NULL, 'Já consegui a skin', '05/04/2020 18:26:41');
INSERT into message
    (messageID, content, dateSent)
VALUES
    (NULL, 'Vai demorar?', '05/04/2020 18:27:40');
INSERT into message
    (messageID, content, dateSent)
VALUES
    (NULL, 'A última live foi muito curta!!! :(', '05/04/2020 18:27:59');
INSERT into message
    (messageID, content, dateSent)
VALUES
    (NULL, 'Ja era pra ter começado :/', '05/04/2020 18:28:13');
INSERT into message
    (messageID, content, dateSent)
VALUES
    (NULL, 'Ei', '05/04/2020 18:28:44');
...
INSERT into stream
    (streamID, channelID, gameID, title, startTime, uptime, ageRestriction, viewerCount)
VALUES
    (1, 4, 7, 'Terror até de madrugada', '21:45', '3:21', 'true', 2765);
INSERT into stream
    (streamID, channelID, gameID, title, startTime, uptime, ageRestriction, viewerCount)
VALUES
    (2, 7, 6, 'Tentando zerar Tomb Raider', '16:56', '2:31', 'false', 1023);
INSERT into stream
    (streamID, channelID, gameID, title, startTime, uptime, ageRestriction, viewerCount)
VALUES
    (3, 6, 8, 'A Temporada está ACABANDO , vamos de Metro Exodus', '20:59', '4:20', 'false', 2750);
INSERT into stream
    (streamID, channelID, gameID, title, startTime, uptime, ageRestriction, viewerCount)
VALUES
    (4, 1, 5, 'Sacomé né vicio', '2:30', '1:10', 'true', 649);
INSERT into stream
    (streamID, channelID, gameID, title, startTime, uptime, ageRestriction, viewerCount)
VALUES
    (5, 4, 3, 'O lobo solitario', '8:40', '4:08', 'false', 580);
INSERT into stream
    (streamID, channelID, gameID, title, startTime, uptime, ageRestriction, viewerCount)
VALUES
    (6, 8, 7, 'Speed run tentando bater meu recorde', '10:40', '2:47', 'false', 463);
...
INSERT into viewership
    (viewershipID, gameID, viewerCount, position)
VALUES
    (NULL, 3, 580, 5);
INSERT into viewership
    (viewershipID, gameID, viewerCount, position)
...
INSERT into genres
    (genresID, tagID, streamID, name, viewerCount, position)
VALUES
    (NULL, 1, 1, 'Horror', 353464, 4);
INSERT into genres
    (genresID, tagID, streamID, name, viewerCount, position)
VALUES
    (NULL, 2, 1, 'Adventura/Action', 863444, 3);
INSERT into genres
    (genresID, tagID, streamID, name, viewerCount, position)
VALUES
    (NULL, 5, 1, 'Fighting ', 232015, 7);
INSERT into genres
    (genresID, tagID, streamID, name, viewerCount, position)
VALUES
    (NULL, 7, 1, 'Shooter', 1123452, 1);
INSERT into genres
    (genresID, tagID, streamID, name, viewerCount, position)
VALUES
    (NULL, 10, 1, 'RPG', 932555, 2);
INSERT into genres
    (genresID, tagID, streamID, name, viewerCount, position)
VALUES
    (NULL, 9, 1, 'Simulator', 335621, 5);
INSERT into genres
    (genresID, tagID, streamID, name, viewerCount, position)
VALUES
    (NULL, 2, 1, 'Wargame', 83665, 8);
INSERT into genres
    (genresID, tagID, streamID, name, viewerCount, position)
VALUES
    (NULL, 8, 1, 'Racing', 252656, 6);
INSERT into genres
    (genresID, tagID, streamID, name, viewerCount, position)
VALUES
    (NULL, 4, 1, 'Trivia ', 63525, 9);